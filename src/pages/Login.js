...
const Login = () => {
    ...
    <div class="w-full max-w-sm p-6 m-auto bg-base-100 rounded-md shadow-md dark:bg-gray-800">
    <h1 class="text-3xl font-semibold text-center text-primary">Login</h1>

    <form class="mt-6">
        <div>
            <label for="username" class="block text-sm text-base-101">Username</label>
            <input type="text"
                class="block w-full px-4 py-2 mt-2 text-gray-700 bg-base-101 border rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" />
        </div>

        <div class="mt-4">
            <div class="flex items-center justify-between">
                <label for="password" class="block text-sm text-base-101">Password</label>
...
// <div class="bg-white flex justify-between flex-col min-h-[100vh] ">
